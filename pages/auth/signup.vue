      ...
      >
        ...
        <div class="mb-6">
          ...
          <input
            ...
            id="password"
            name="password"
            class="border mb-3 text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-green-500 focus:border-green-500"
            required
